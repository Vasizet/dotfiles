...
sudo pacman -S --noconfirm --needed hyprland mako waybar micro kitty hyprpaper wofi
...
ln -sf $DOTFILES_DIR/catnap $CONFIG_DIR/catnap
ln -sf $DOTFILES_DIR/hypr/waybar $CONFIG_DIR/hypr
